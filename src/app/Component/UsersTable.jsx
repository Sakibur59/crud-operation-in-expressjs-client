...
const roleConfig = {
  admin:     { label: "Admin",     bg: "bg-rose-50",   text: "text-rose-700",   dot: "bg-rose-500"   },
  moderator: { label: "Moderator", bg: "bg-amber-50",  text: "text-amber-700",  dot: "bg-amber-500"  },
  editor:    { label: "Editor",    bg: "bg-violet-50", text: "text-violet-700", dot: "bg-violet-500" },
  user:      { label: "User",      bg: "bg-emerald-50",text: "text-emerald-700",dot: "bg-emerald-500"},
};
...
const RoleBadge = ({ role }) => {
  const cfg = roleConfig[role] ?? { label: role, bg: "bg-gray-100", text: "text-gray-600", dot: "bg-gray-400" };
  return (
